...
$max_size_upload_dir = 50000000; // Bytes
$token = 'b49837d1fea65f892651057ae5c31f6f';

$reply = false;

$upload_dir = get_config('local_exam_authorization', 'upload_dir');
if (empty($upload_dir)) {
    $upload_dir = '/var/tmp';
}
if (!is_writable($upload_dir)) {
    $reply = array('status' => 1, 'msg' => "Sem permissão de escrita em: '$upload_dir'.");
}
